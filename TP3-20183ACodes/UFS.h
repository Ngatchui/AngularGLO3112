/**************************************************************************
	...
	Fichier .h contenant les structures necessaires au travail pratique 3.

	Systemes d'explotation GLO-2001/IFT-2001
	Universite Laval, Quebec, Qc, Canada.
	(c) 2018 Philippe Giguere
 **************************************************************************/
#ifndef UFS_H
#define UFS_H
...
#define N_BLOCK_PER_INODE 14    // nombre maximal de bloc de donnees associe a un i-node
#define N_INODE_ON_DISK   20	// nombre maximal d'i-node (donc de fichier) sur votre disque
#define BLOCK_SIZE 512			// taille d'un bloc de donnee
#define N_BLOCK_ON_DISK 128		// nombre de bloc sur le disque au complet
