/**************************************************************************
	...
	(c) 2019 Philippe Giguere
	
	3e6a98197487be5b26d0e4ec2051411f

	Une seule chose à modifier ici, le elseif de votre fonction personnalisée
...
int main(int argc, char **argv) {
	...
	printf("\n");
	// ========== commande blockused() =============
	if (strcmp(argv[1],"blockused")==0) {
		if (argc!=2) { 
			printf("La commande blockused demande 0 argument!\n");
			printf("   ufs blockused\n");
			return 1;
		}
		RetVal = bd_countusedblocks();
		printf("Nombre de blocs utilisé: %d\n",RetVal);
	} // ========== commande bd_stat() =============
	...
	} // ========== commande bd_truncate() =============
	else if (strcmp(argv[1],"truncate")==0) {
		if (argc!=4) {
			printf("La commande truncate demande 2 argument!\n");
			printf("   ufs truncate nom_fichier nouvelle_taille\n");
			return 1;
		}
		RetVal = bd_truncate(argv[2],atoi(argv[3]));
	}
	// ========== commande bd_FormatDisk() =============
	else if (strcmp(argv[1],"format")==0) {
		if (argc!=2) { 
			printf("La commande format demande 0 argument!\n");
			printf("   ufs format\n");
			return 1;
		}
		RetVal = bd_formatdisk();
		printf("Disque formate\n");
	}



	// ========== fonction personnalisée() =====================================================================================================
	// la seule partie que vous pouvez modifier
	...
	// ========== fonction personnalisée() - fin de la partie modifiable ========================================================================
	else {
